...
(function () {
  ...
  function fetchResource(res, _ref7) {
    var code = _ref7.code;
    var src = _ref7.src;
    var ver = _ref7.ver;
  ...
  function format(ctx, lang, args, entity) {
    ...
    try {
      rv = resolveValue({}, ctx, lang, args, entity);
    } finally {
  ...
  function resolveMessage(ctx, lang, args, expr) {
    ...
    if (entity) {
      var _format = format(ctx, lang, args, entity);

      var locals = _format[0];
      var value = _format[1];
  ...
  function resolveCall(ctx, lang, args, expr) {
    var _resolveBuiltin = resolveBuiltin(ctx, lang, args, expr.callee);

    var callee = _resolveBuiltin[1];

    return [{}, callee.apply(null, expr.args.map(function (argExpr) {
      return resolveExpression({}, ctx, lang, args, argExpr)[1];
    }))];
  }
  ...
  function resolveMember(ctx, lang, args, expr) {
    ...
    var entity = ctx._getEntity(lang, object);
  ...
  function defaultVariant(variants) {
    for (var _iterator4 = variants, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
      var _ref4;
  ...
  function resolvePlaceable(locals, ctx, lang, args, placeable, explicit) {
    try {
      var expr = explicit || placeable.expr && resolveExpression(locals, ctx, lang, args, placeable.expr)[1];

      if (!expr) {
        return resolveValue(locals, ctx, lang, args, defaultVariant(placeable.variants).value);
      }
      ...
      if (typeof expr === 'function') {
        for (var _iterator5 = placeable.variants, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
          var _ref5;
        ...
        for (var _iterator6 = placeable.variants, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
          var _ref6;
  ...
  function resolveValue(locals, ctx, lang, args, elements) {
    return elements.reduce(function (_ref9, cur) {
      var localsSeq = _ref9[0];
      var valueSeq = _ref9[1];

      if (cur.type === 'textElement') {
        return [localsSeq, valueSeq + cur.value];
      } else if (cur.type === 'placeableElement') {
        var _resolvePlaceable = resolvePlaceable(locals, ctx, lang, args, cur);

        var value = _resolvePlaceable[1];
    ...
    if (!(index in pluralRules)) {
      return function (n) {
        return function (selector) {
          return selector === n || selector === 'other';
        };
      };
    }
    return function (n) {
      var category = pluralRules[index](n);
      return function (selector) {
        return selector === n || selector === category;
      };
    };
  }
  ...
  var Context = (function () {
    ...
    Context.prototype._resolve = function _resolve(langs, keys, formatter, prevResolved) {
      ...
      var resolved = keys.map(function (key, i) {
        ...
        var _ref10 = Array.isArray(key) ? key : [key, undefined];
  ...
  function negotiateLanguages(_ref11, additionalLangs, prevLangs, requestedLangs) {
    var appVersion = _ref11.appVersion;
    var defaultLang = _ref11.defaultLang;
    var availableLangs = _ref11.availableLangs;
